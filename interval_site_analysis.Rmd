...
=============================
Changes in hive characteristics may be more meaningful if they are expressed relative to the initial values.  
...
aggregated_initial <- aggregate( . ~ site_code  ,data=frame_wide[,grepl("_initial|site_code",colnames(frame_wide))], FUN=mean)
...
fm_1 <- lm(seam_chg_total~mean_total_planting + seam_initial + pollen_chg_total , data=site_wide)
print("Does neonic exposure in during planting affect bee population change (as measured by # of seams) throughout the season?")
print(summary(fm_1)) # negative effect on bee population change (measured by seams filled w/bees)

fm_2 <- lm(bee_chg_total~mean_total_planting+bee_initial+pollen_chg_total,data=site_wide)
print("Does neonic exposure during planting affect bee population change (as measured by frame area covered by bees) throughout the season?")
print(summary(fm_2)) # borderline non-sig negative effect on bee pop change (measured by area covered by bees)

fm_3 <- lm(open_chg_total~mean_total_planting+open_initial+pollen_chg_total,data=site_wide)
print("Does neonic exposure during planting affect change in open brood area throughout the season?")
print(summary(fm_3)) # negative effect on open brood change

fm_4 <- lm(cap_chg_total~mean_total_planting+cap_initial+pollen_chg_total,data=site_wide)
print("Does neonic exposure during planting affect change in capped brood area throughout the season?")
print(summary(fm_4)) # no effect on capped brood change

fm_5 <- lm(pollen_chg_total~mean_total_planting+pollen_initial,data=site_wide)
print("Does neonic exposure during planting affect change in pollen throughout the season?")
print(summary(fm_5))# no effect on pollen change

fm_6 <- lm(nectar_chg_total~mean_total_planting+nectar_initial + pollen_chg_total,data=site_wide)
print("Does neonic exposure during planting affect change in nectar throughout the season?")
print(summary(fm_6))# no effect on nectar change
